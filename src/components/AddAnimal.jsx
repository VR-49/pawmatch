  ...
  return (
    <form onSubmit={handleSumbit}>
      ...
      <label>
        ...
        <input
          type='text'
          value={animalPersonalityInput}
          onChange={(event) => setAnimalPersonality(event.target.value)}
        />
      </label>
      <label>
        {' '}
        ...
        <input
          type='text'
          value={animalAboutInput}
          onChange={(event) => setAnimalAbout(event.target.value)}
        />
      </label>
